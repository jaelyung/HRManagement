...
public class HrEmailSearch implements HrExecute{
	@Override
	...
	public void logic(Request request, Response response) {
		...
		System.out.println("검색할 Email을 입력하세요");
		String userInput=sc.nextLine();
		String email=userInput.toUpperCase();
		
		response.setArrHrDto(dao.emailSearch(email));
	}
