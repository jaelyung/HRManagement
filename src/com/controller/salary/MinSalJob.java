...
public class MinSalJob implements HrExecute {
	...
	public void logic(Request request, Response response) {
		HrDao dao=new HrDao();
		response.setArrHrDto(dao.minSalJob(JobIdCheck.jobId));
	...
	public void outputView(Request request, Response response) {
		if(response!=null) {
			...
			System.out.println("");
			System.out.println(" [직무 내 최저급여] ");
			for(HrDto dto:dtos) {
				System.out.println(dto.minSalJob());
			}
			if(dtos.isEmpty()) {
