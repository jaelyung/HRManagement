...
public class AvgSalJob implements HrExecute {
	...
	public void logic(Request request, Response response) {
		HrDao dao=new HrDao();
		response.setArrHrDto(dao.avgSalJob(JobIdCheck.jobId));
	...
	public void outputView(Request request, Response response) {
		if(response!=null) {
			...
			System.out.println("");
			System.out.println(" [직무 급여 평균] ");
			for(HrDto dto:dtos) {
				System.out.println(dto.avgSalJob());
			}
			if(dtos.isEmpty()) {
